...
let favoriteFoods = ['tacos', 'pizza', 'friedrice', 'bbqribs']
...
let lastAnimalLength = animalArray[animalArray.length-1]
console.log('Last animal is:', lastAnimal)
console.log(animalArray)
...
console.log('added a dessert:', favoriteFoods[favoriteFoods.length - 1]);
console.log(favoriteFoods.indexOf('cake'));
